...
ggplot(data=d1,aes(d1$data.data.Year))+geom_histogram(color="dark blue",fill="orange", binwidth=1/2)+xlab("Year")+ylab("Occurrences")+ggtitle("Total Crime Occurrences from 2001 to 2016")
...
colnames(df25T5)<-c("Location","Occurrence Percentage")
print(df25T5)
